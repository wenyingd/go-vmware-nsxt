...
type UploadBundleStatus struct {
	...
	// Current state of bundle upload. UPLOADING - Upload in progress. VERIFYING - Verifying signature of uploaded bundle. SUCCESS - Upload complete. FAILED - Upload failed. 
