...
type SecurityPolicy struct {
	...
	// Indicates whether the security policy is meant for NSX DFW or for Antrea Container Cluster. If the policy is applicable for both NSX DFW and ANTREA, then the value will be DFW_ANTREA 
